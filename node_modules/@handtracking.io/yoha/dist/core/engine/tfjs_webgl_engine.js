...
import { CreateTfjsModelFromModelBlobs, CreateModelCbFromTfjsModel, GetInputDimensionsFromTfjsModel, } from '../model/tfjs';
 ...
 */
export async function StartTfjsWebglEngine(config, trackSource, yohaModels, resCb) {
    const [boxModel, lanModel] = await Promise.all([
        CreateTfjsModelFromModelBlobs(yohaModels.box, "WEBGL" /* WEBGL */),
        CreateTfjsModelFromModelBlobs(yohaModels.lan, "WEBGL" /* WEBGL */),
    ]);
...
//# sourceMappingURL=tfjs_webgl_engine.js.map